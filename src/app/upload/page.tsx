  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-10rem)] max-w-4xl mx-auto w-full px-4">
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-muted-foreground">We'll extract your details and help you tailor it for any job.</p>
      </div>
      ...
      {!isSuccess ? (
        ...
        >
          <div className={`h-20 w-20 rounded-full bg-primary/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform ${isUploading ? 'animate-pulse' : ''}`}>
            <UploadCloud className="h-10 w-10 text-primary" />
          </div>
          
          <div className="text-center space-y-2">
            <h3 className="text-xl font-semibold">
              {isUploading ? "Uploading & Analyzing..." : "Click or drag your resume here"}
            </h3>
            <p className="text-muted-foreground">Supports PDF, DOCX (Max 10MB)</p>
          </div>
        ...
        <Card className="w-full border-primary/20 bg-green-500/5 p-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-sm">
            We've successfully extracted your profile. You can now start tailoring it or edit the details manually.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
            <Button className="flex-1 h-12 text-base shadow-lg shadow-primary/20" asChild>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        {[
          { title: "Smart Extraction", desc: "Auto-populates your profile using AI.", icon: CheckCircle },
          { title: "ATS Optimized", desc: "Formats that pass recruiter filters.", icon: CheckCircle },
          { title: "100% Private", desc: "Your data is encrypted and secure.", icon: CheckCircle },
        ].map((feat, i) => (
